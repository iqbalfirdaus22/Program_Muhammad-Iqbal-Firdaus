<?php
	...
	//	.....
    // membuat fungsi menghitung tagihan awal dengan variabel $harga dan $jumlah
	function hitung_tagihan_awal($harga, $jumlah){ 
		//tagihan awal diambil dari variabel  harga dikalikan dengan variabel jumlah
		$tagihanAwal= $harga * $jumlah;
		// mengembalikan nilai tagihan awal
		return $tagihanAwal;
	}
...
<html>
	<head>
		<title>Form Pemesanan Nasi Kotak Warung Iqbal</title>
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			if ($tagihanAwal>=1000000) {
					// diskon 5% dikali tagihan awal
				$diskon = (5/100) * $tagihanAwal; 
					// maka hasil tagihan akhir akan mendapatkan diskon
				$tagihanAkhir = $tagihanAwal - $diskon;
			}
			else{
				// jika tidak lebih dari 1 juta maka tidak dapat diskon
